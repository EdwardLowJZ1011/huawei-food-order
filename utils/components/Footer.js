        ...
        <div className="container">
            ...
            <div className="row col-mb-30">
                ...
                <div className="col-md-6 text-center text-md-start">
                    Copyrights &copy; 2022 All Rights Reserved by Low Jin Zhang.<br />
                ...
                <div className="col-md-6 text-center text-md-end">
                    ...
                    <i className="icon-envelope2"></i> webotitsolutionservice@gmail.com <span className="middot">&middot;</span> <i className="icon-headphones"></i> +011-10685882 <span className="middot">&middot;</span> <i className="icon-skype2"></i> WeBot IT Solution Services
                </div>
